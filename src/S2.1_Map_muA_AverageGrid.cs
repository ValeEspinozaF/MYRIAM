...
namespace MYRIAM
{
    internal class FNCT_muA_MAPPER
    {
            ...
            )
        {
             ...
             * use the upper portion of the asthenosphere specified through the input "FRACTION_HA" 
            ...
            // Filter layers to depths of asphenosphere (HL <= p <= (HL + HA_PR09 * FRACTION_HA)) 
            ...
            if (z_PM13_2use.Length == 0)
                throw new ArgumentException(
                    "Error! " +
                    "Combination of given HL and FRACTION_HA yield a layer of thickness smaller " +
